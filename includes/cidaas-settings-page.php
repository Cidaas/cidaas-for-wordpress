...
class Cidaas_Settings_Page {
	...
	// options page slug
	private $options_page_name = 'cidaas-settings';
	...
	function __construct( Cidaas_Option_Settings $settings, Cidaas_Option_Logger $logger ) {
		...
		$fields = array(
			'login_type'        => array(
				...
				'type'        => 'select',
				'options'     => array(
					'button' => __( 'Cidaas button on login form' ),
			...
			'client_id'         => array(
				'title'       => __( 'Client ID' ),
				'description' => __( 'The ID this client will be recognized as when connecting the to Cidaas server.' ),
		...
		$fields = apply_filters( 'cidaas-settings-fields', $fields );
	 ...
	 * @param \Cidaas_Option_Logger $logger
	 *
	 * @return \Cidaas_Settings_Page
	 */
	static public function register( Cidaas_Option_Settings $settings, Cidaas_Option_Logger $logger ){
	...
	public function settings_page() {
		...
		<div class="wrap">
			...
			<form method="post" action="options.php">
				...
				if ( isset(sanitize_text_field($_GET['debug']) ) ) {
